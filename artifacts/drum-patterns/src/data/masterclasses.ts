...
export const producers: Producer[] = [
  ...
  // ─── AKHENATON ────────────────────────────────────────────────────────────────
  {
    ...
    kitPads: [
      { position: "A1", instrument: "Kick",          sound: "Deep, hard boom bap kick",           pack: "Sticks Toolkit",   processing: "EQ: boost 60Hz +2dB, cut 200Hz -3dB. No reverb. Hard transient. This is the Marseille foundation.", color: "kick" },
      { position: "A2", instrument: "Snare",          sound: "Hard, tight East Coast snare",       pack: "Sticks Toolkit",   processing: "Very short room reverb: 0.4s, 15% wet. Keep it dry and sharp.", color: "snare" },
      { position: "A3", instrument: "Closed Hat",     sound: "Dark, quiet hi-hat",                 pack: "Sticks Toolkit",   processing: "High-pass at 4kHz. Velocity 42 flat. Background rhythm — never dominant.", color: "hat" },
      { position: "A4", instrument: "Open Hat",       sound: "Medium open hat — the lilt",        pack: "Sticks Toolkit",   processing: "Choke with A3. Velocity 65. Step 10 only — once per bar.", color: "hat" },
      { position: "B1", instrument: "Ghost Snare",    sound: "Same snare — near-silent",           pack: "Sticks Toolkit",   processing: "Velocity 25-30 only. Steps 14 and occasionally 6.", color: "snare" },
      { position: "B2", instrument: "Vinyl Crackle",  sound: "Looped vinyl noise",                 pack: "Weekday (free)",   processing: "Loop at velocity 20. The Marseille street — dusty like the source records.", color: "perc" },
      { position: "B3", instrument: "Hand Perc",      sound: "Light hand percussion hit",          pack: "Chronicles",       processing: "Used sparingly — one hit per 4 bars maximum. Adds texture from North African percussion tradition.", color: "perc" },
    ],
    techniques: [
    ...
    packRecs: [
      { pack: "Soulful Dreams Vol 1 & 2", why: "The darker loops carry the minor tonality and emotional weight of Akhenaton's source material. Filter below 9kHz and narrow the stereo image to 25% before using." },
      { pack: "Weekday (free)", why: "Vinyl crackle loops for the dusty foundation. Akhenaton's beats feel like they came from someone's grandfather's record collection.", free: true },
      { pack: "Sticks Toolkit", why: "Raw, unprocessed drum sounds — choose the most minimal options. Akhenaton's drums are tools, not statements." },
      { pack: "Chronicles", why: "Light percussion elements for occasional accents from the North African and Mediterranean hand percussion tradition." },
    ],
    microKeyTips: [
  ...
  // ─── DJ MEHDI ─────────────────────────────────────────────────────────────────
  {
    ...
    kitPads: [
      { position: "A1", instrument: "Main Kick",     sound: "Round, warm kick with clear transient", pack: "Sticks Toolkit",  processing: "EQ: boost 80Hz +2dB, cut 250Hz -2dB. Short room reverb 0.3s at 10% — barely a touch.", color: "kick" },
      { position: "A2", instrument: "Snare",         sound: "Centered crack — mid-forward snare",    pack: "Sticks Toolkit",  processing: "Reverb: Room, 0.7s, 20% wet. EQ: boost 2kHz +2dB for crack, cut 400Hz -2dB.", color: "snare" },
      { position: "A3", instrument: "Closed Hat",    sound: "Warm, slightly dark hi-hat",            pack: "Sticks Toolkit",  processing: "Velocity humanize on. Downbeats: 75. Upbeats: 38. High-pass at 6kHz.", color: "hat" },
      { position: "A4", instrument: "Ghost Snare",   sound: "Same snare — near-inaudible",           pack: "Sticks Toolkit",  processing: "Velocity 20-28. Steps 6 and 14 only.", color: "snare" },
      { position: "B1", instrument: "Accent Snare",  sound: "Same snare — mid-velocity accent",      pack: "Sticks Toolkit",  processing: "Velocity 78. Step 11 only — the Premier/Mehdi accent hit.", color: "snare" },
      { position: "B2", instrument: "Jazz Perc",     sound: "Brushed rim or jazz snare hit",         pack: "Chronicles",      processing: "Velocity 30 flat. Used as texture — 2-3 hits per 16 bars max.", color: "perc" },
      { position: "B3", instrument: "Vinyl Crackle", sound: "Looped vinyl noise",                    pack: "Weekday (free)",  processing: "Velocity 18. Always running. Mehdi's beats are warm because of this layer.", color: "perc" },
    ],
    techniques: [
      ...
      { title: "Horn Layer as Countermelody", detail: "After the sample is running, load a horn or brass one-shot from Odyssey Soul on pad B4. Place it on an off-beat position — step 9 or 13 — responding to the sample's melodic content. Mehdi loved call-and-response between the looped source and a single horn hit. Velocity 72, no reverb." },
    ...
    packRecs: [
      { pack: "Soulful Dreams Vol 1 & 2", why: "Jazz-inflected and soul loops with chord changes and live instrument feel. Look for loops with movement — not static one-chord loops. These are Mehdi's exact source territory." },
      { pack: "Odyssey Soul", why: "Horn and brass one-shots for Mehdi's countermelody technique. Layer a single horn hit on an off-beat step as a call-and-response with the sample." },
      { pack: "Weekday (free)", why: "Vinyl crackle at velocity 18 running underneath everything. The Paris golden era warmth foundation.", free: true },
      { pack: "Chronicles", why: "Jazz percussion and brushed hits for texture elements at very low velocity." },
    ],
    microKeyTips: [
  ...
  // ─── MYTH SYZER ───────────────────────────────────────────────────────────────
  {
    ...
    kitPads: [
      { position: "A1", instrument: "Kick",          sound: "Punchy, warm boom bap kick",          pack: "Sticks Toolkit",    processing: "EQ: boost 80Hz +2dB tight Q, cut 200Hz -2dB. Slight transient enhancement: attack 0ms, sustain +1.", color: "kick" },
      { position: "A2", instrument: "Snare",          sound: "Warm, mid-forward snare",             pack: "Sticks Toolkit",    processing: "Reverb: Room, 0.8s, 25% wet. Sits slightly below sample in the mix.", color: "snare" },
      { position: "A3", instrument: "Closed Hat",     sound: "Bright, tight hat for 16ths",        pack: "Sticks Toolkit",    processing: "Apply velocity slope manually per pattern notes. High-pass at 7kHz.", color: "hat" },
      { position: "A4", instrument: "Ghost Snare",    sound: "Same snare — near-inaudible",         pack: "Sticks Toolkit",    processing: "Velocity 22-28. Steps 6 and 13 only.", color: "snare" },
      { position: "B1", instrument: "Perc / Shaker",  sound: "Light shaker or brush hit",           pack: "Chronicles",        processing: "Velocity 30 flat. Adds organic movement when 16th hats feel too robotic.", color: "perc" },
      { position: "B2", instrument: "Vinyl Crackle",  sound: "Looped vinyl noise",                  pack: "Weekday (free)",    processing: "Velocity 22. Always running. Modern Parisian warmth.", color: "perc" },
    ],
    techniques: [
    ...
    packRecs: [
      { pack: "Soulful Dreams Vol 1 & 2", why: "The warmest, most chord-rich loops in your collection. Look specifically for 2-bar loops with chord changes — Myth Syzer's exact source territory." },
      { pack: "Weekday (free)", why: "Vinyl crackle at velocity 22 running underneath everything. The warmth foundation of the modern Parisian sound.", free: true },
      { pack: "Sticks Toolkit", why: "Clean, warm drum sounds — choose the round, present options. Modern boom bap needs clean drums under warm samples." },
      { pack: "Chronicles", why: "Light percussion for organic texture. Use sparingly — one shaker or brush hit per 4 bars as subliminal movement." },
    ],
    microKeyTips: [
  ...
  // ─── MORLOCKKO PLUS ───────────────────────────────────────────────────────────
  {
    ...
    kitPads: [
      { position: "A1", instrument: "Kick",          sound: "Hard boxy boom bap kick",             pack: "Sticks Toolkit",    processing: "EQ: cut 200Hz -3dB (remove boxiness), boost 60Hz +2dB. No reverb. Direct and cold.", color: "kick" },
      { position: "A2", instrument: "Snare",          sound: "Medium-crack snare with long reverb", pack: "Sticks Toolkit",    processing: "Reverb: Hall, 1.2s, 30% wet. EQ: boost 3kHz +1dB for crack. The reverb tail IS the character.", color: "snare" },
      { position: "A3", instrument: "Closed Hat",     sound: "Dark, quiet hat",                     pack: "Sticks Toolkit",    processing: "Velocity 38-42 flat. High-pass at 5kHz. Atmospheric rhythm only — never dominant.", color: "hat" },
      { position: "A4", instrument: "Ghost Snare",    sound: "Same snare — near silent",            pack: "Sticks Toolkit",    processing: "Velocity 22-28. Step 14 only. Pre-bar tension.", color: "snare" },
      { position: "B1", instrument: "Vinyl Crackle",  sound: "Library record noise",                pack: "Weekday (free)",    processing: "Velocity 20. Always running. This is the East German library record beneath everything.", color: "perc" },
      { position: "B2", instrument: "Low Percussion", sound: "Occasional low thud or tom",          pack: "Chronicles",        processing: "Used once every 8-16 bars for variation. Velocity 70. Announces section changes.", color: "perc" },
    ],
    techniques: [
    ...
    packRecs: [
      ...
      { pack: "Weekday (free)", why: "Vinyl crackle at velocity 20. The constant background noise is structural in Morlockko's beats — it places the music in a specific physical and historical space.", free: true },
      { pack: "Chronicles", why: "Occasional deep percussion for section markers. One deep thud or low tom to announce the end of an 8-bar cycle." },
      { pack: "Sticks Toolkit", why: "Choose the rawer, less processed drum sounds. Morlockko's drums are tools — functional, not decorative." },
    ],
    microKeyTips: [
  ...
  // ─── JOHNNY ILLSTRUMENT ───────────────────────────────────────────────────────
  {
    ...
    kitPads: [
      { position: "A1", instrument: "Main Kick",    sound: "Hard, punchy boom bap kick",          pack: "Sticks Toolkit",    processing: "Transient: attack 0ms, sustain +1. EQ: boost 80Hz +3dB, cut 300Hz -2dB. No reverb.", color: "kick" },
      { position: "A2", instrument: "Ghost Kick",   sound: "Same kick — softer",                  pack: "Sticks Toolkit",    processing: "Velocity 78. Used on step 6 for the Premier displacement. Same processing as A1.", color: "kick" },
      { position: "A3", instrument: "Snare",        sound: "Loud, present snare — front of mix",  pack: "Sticks Toolkit",    processing: "Reverb: Room, 0.8s, 25% wet. This snare is NOT shy. Velocity 100 on beats 2 and 4.", color: "snare" },
      { position: "A4", instrument: "Accent Snare", sound: "Same snare — step 11 accent",        pack: "Sticks Toolkit",    processing: "Velocity 82. Step 11 only. Independent pad from A3.", color: "snare" },
      { position: "B1", instrument: "Closed Hat",   sound: "Tight 8th-note hat",                  pack: "Sticks Toolkit",    processing: "Velocity 55 with humanize ±5. High-pass at 6kHz.", color: "hat" },
      { position: "B2", instrument: "Open Hat",     sound: "Short open hat — step 10 accent",    pack: "Sticks Toolkit",    processing: "Choke Group with B1. Velocity 70. Once per bar only.", color: "hat" },
      { position: "B3", instrument: "Vinyl Crackle", sound: "Looped record noise",               pack: "Weekday (free)",    processing: "Velocity 22. Continuous loop. The Berlin underground runs on vinyl.", color: "perc" },
    ],
    techniques: [
    ...
    packRecs: [
      { pack: "Soulful Dreams Vol 1 & 2", why: "German jazz-funk equivalents — warm, live-sounding loops. Use 2-bar loops where the sample drummer and your programmed drums can lock together." },
      { pack: "Sticks Toolkit", why: "Clean, confident drum sounds — choose the most present and forward options. Berlin boom bap uses polished drums: clean and loud." },
      { pack: "Weekday (free)", why: "Vinyl crackle running continuously at velocity 22. Places the record in the Berlin underground scene.", free: true },
      { pack: "Chronicles", why: "Additional percussion for occasional texture. One well-placed hit per 8 bars — restraint is part of the Berlin approach." },
    ],
    microKeyTips: [
  ...
  // ─── FIGUB BRAZLEVIC ──────────────────────────────────────────────────────────
  {
    ...
    kitPads: [
      { position: "A1", instrument: "Kick",            sound: "Round kick tuned to sample key",     pack: "Sticks Toolkit",    processing: "Tune to sample root note. EQ: boost 80Hz and 3kHz. Figub's kick is a musical instrument.", color: "kick" },
      { position: "A2", instrument: "Main Snare",       sound: "Hard crack snare",                   pack: "Sticks Toolkit",    processing: "Reverb: Hall, 1.0s, 25% wet. The reverb tail is the cinematic space Figub creates.", color: "snare" },
      { position: "A3", instrument: "Brushed Snare",    sound: "Jazz brushed snare or rim",          pack: "Chronicles",        processing: "Velocity 35. Pad Link to A2. The 'hair' on the snare — quiet, adds texture.", color: "snare" },
      { position: "A4", instrument: "Ghost Snare",      sound: "Same hard snare — near-silent",      pack: "Sticks Toolkit",    processing: "Velocity 20. Step 14 only.", color: "snare" },
      { position: "B1", instrument: "Closed Hat",       sound: "Quarter-note pulse hat",             pack: "Sticks Toolkit",    processing: "Velocity 52. High-pass at 6kHz. Just keeping time — the sample tells the story.", color: "hat" },
      { position: "B2", instrument: "Vinyl Crackle",    sound: "World music record crackle",         pack: "Weekday (free)",    processing: "Velocity 18. Running continuously. Places the sample in its vinyl context.", color: "perc" },
      { position: "B3", instrument: "Solo Instrument",  sound: "Trumpet or violin one-shot",         pack: "Odyssey Soul",      processing: "Used as melodic counterpoint on off-beats. Velocity 65. One note per 2 bars maximum.", color: "synth" },
    ],
    techniques: [
      { title: "Harmonic Kick (Figub's Core Technique)", detail: "Load your kick on pad A1. Go to Tune in Pad settings. Identify the root note of your sample. Set the kick's Tune parameter so its fundamental frequency matches that root note — use a round, resonant kick from Sticks Toolkit that has a clear pitch. This harmonic kick becomes a bass drum that sings the key of the track, creating a subconscious musical cohesion that listeners feel without identifying." },
      { title: "The Brushed Snare Layer", detail: "Find a jazz brushed snare sound in Chronicles. Load on pad A3. Set Pad Link to trigger simultaneously with your main snare (A2). Set A3 velocity to 35 (much quieter). The brushed snare adds a textural hiss around the crack of the main snare. Together they create a complex snare that sounds like one instrument played by a very experienced drummer — this is the Figub snare texture." },
    ...
    packRecs: [
      ...
      { pack: "Odyssey Soul", why: "Solo instrument one-shots (trumpet, strings, piano) for the counterpoint technique. Figub's solo note responses to the sample come from real instrument sounds, not synth patches." },
      { pack: "Weekday (free)", why: "Vinyl crackle from world music sources at velocity 18. Figub's samples come from many traditions — the crackle grounds them in a physical medium.", free: true },
      { pack: "Chronicles", why: "Brushed snare and jazz percussion sounds for layering. The brushed snare layer is essential to the Figub snare texture." },
    ],
    microKeyTips: [
